...
const (
	PublicPemFile = ".\\publickeyread\\rsa_public.pem"
	PublicPKCS1PemFile = ".\\publickeyread\\rsa_public_pkcs1.pem"
	PrivatePemFile = ".\\publickeyread\\rsa_private.pem"
	PrivatePKCS1PemFile = ".\\publickeyread\\rsa_private_pkcs1.pem"
)
