...
// Example:
//
//	g, err := td.DecodeUploadCDNFile(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.UploadCDNFileReuploadNeeded: // upload.cdnFileReuploadNeeded#eea8e46e
//	case *td.UploadCDNFile: // upload.cdnFile#a99fca4f
//	default: panic(v)
//	}
