...
// Example:
//
//	g, err := td.DecodeAuthCodeType(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.AuthCodeTypeSMS: // auth.codeTypeSms#72a3158c
//	case *td.AuthCodeTypeCall: // auth.codeTypeCall#741cd3e3
//	case *td.AuthCodeTypeFlashCall: // auth.codeTypeFlashCall#226ccefb
//	case *td.AuthCodeTypeMissedCall: // auth.codeTypeMissedCall#d61ad6ee
//	case *td.AuthCodeTypeFragmentSMS: // auth.codeTypeFragmentSms#6ed998c
//	default: panic(v)
//	}
