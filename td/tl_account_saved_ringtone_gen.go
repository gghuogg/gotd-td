...
// Example:
//
//	g, err := td.DecodeAccountSavedRingtone(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.AccountSavedRingtone: // account.savedRingtone#b7263f6d
//	case *td.AccountSavedRingtoneConverted: // account.savedRingtoneConverted#1f307eb7
//	default: panic(v)
//	}
