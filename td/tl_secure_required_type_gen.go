...
// Example:
//
//	g, err := td.DecodeSecureRequiredType(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.SecureRequiredType: // secureRequiredType#829d99da
//	case *td.SecureRequiredTypeOneOf: // secureRequiredTypeOneOf#27477b4
//	default: panic(v)
//	}
