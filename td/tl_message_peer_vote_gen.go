...
// Example:
//
//	g, err := td.DecodeMessagePeerVote(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.MessagePeerVote: // messagePeerVote#b6cc2d5c
//	case *td.MessagePeerVoteInputOption: // messagePeerVoteInputOption#74cda504
//	case *td.MessagePeerVoteMultiple: // messagePeerVoteMultiple#4628f6e6
//	default: panic(v)
//	}
