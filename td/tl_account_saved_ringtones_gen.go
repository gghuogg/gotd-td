...
// Example:
//
//	g, err := td.DecodeAccountSavedRingtones(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.AccountSavedRingtonesNotModified: // account.savedRingtonesNotModified#fbf6e8b1
//	case *td.AccountSavedRingtones: // account.savedRingtones#c1e92cc5
//	default: panic(v)
//	}
