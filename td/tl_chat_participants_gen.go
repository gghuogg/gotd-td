...
// Example:
//
//	g, err := td.DecodeChatParticipants(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.ChatParticipantsForbidden: // chatParticipantsForbidden#8763d3e1
//	case *td.ChatParticipants: // chatParticipants#3cbc93f8
//	default: panic(v)
//	}
