...
// Example:
//
//	g, err := td.DecodeAccountWallPapers(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.AccountWallPapersNotModified: // account.wallPapersNotModified#1c199183
//	case *td.AccountWallPapers: // account.wallPapers#cdc3858c
//	default: panic(v)
//	}
