...
// Example:
//
//	g, err := td.DecodeExportedChatInvite(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.ChatInviteExported: // chatInviteExported#ab4a819
//	case *td.ChatInvitePublicJoinRequests: // chatInvitePublicJoinRequests#ed107ab7
//	default: panic(v)
//	}
