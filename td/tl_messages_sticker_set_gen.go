...
// Example:
//
//	g, err := td.DecodeMessagesStickerSet(buf)
//	if err != nil {
//	    panic(err)
//	}
//	switch v := g.(type) {
//	case *td.MessagesStickerSet: // messages.stickerSet#6e153f16
//	case *td.MessagesStickerSetNotModified: // messages.stickerSetNotModified#d3f924eb
//	default: panic(v)
//	}
